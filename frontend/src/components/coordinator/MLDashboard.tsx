...
export default function MLDashboard() {
    ...
    const handleFeatureChange = (key: string, value: any) => {
        setFeatures((prev: any) => {
            // Ignore invalid numeric edits (e.g. empty number input parsing to NaN).
    ...
    const getSafeNumberValue = (value: any) => (typeof value === 'number' && Number.isFinite(value) ? value : '')
            ...
            {activeView === 'moe' ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/2 p-6">
                        ...
                        <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-linear-to-br from-indigo-600 to-blue-700 p-6 text-white overflow-hidden relative">
                    ...
                    {/* Sandbox Prediction */}
                    <div className="lg:col-span-2 rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/2 p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <input
                                            type="number"
                                            value={getSafeNumberValue(features.temperature)}
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <input
                                            type="number"
                                            value={getSafeNumberValue(features.wind_speed)}
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <input
                                            type="number"
                                            value={getSafeNumberValue(features.humidity)}
                                    ...
                                    {selectedType === 'spread' && (
                                        <div className="space-y-1.5 col-span-2">
                                            ...
                                            <input
                                                type="number"
                                                value={getSafeNumberValue(features.current_area)}
                                    ...
                                    {selectedType === 'impact' && (
                                        <div className="space-y-1.5 col-span-2">
                                            ...
                                            <input
                                                type="number"
                                                value={getSafeNumberValue(features.affected_population)}
                            ...
                            {/* Result Output */}
                            <div className="relative min-h-50 rounded-2xl border border-dashed border-slate-200 dark:border-white/10 flex flex-col items-center justify-center p-6 bg-slate-50/50 dark:bg-white/1">

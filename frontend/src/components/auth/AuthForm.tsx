    ...
    const GoogleButton = () => (
        <>
            <button
                ...
                disabled={isLoading}
                className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 font-bold h-11 rounded-xl flex items-center justify-center gap-2 hover:bg-blue-100 hover:text-blue-400 dark:hover:bg-slate-750  transition-all disabled:opacity-50 disabled:cursor-not-allowed">

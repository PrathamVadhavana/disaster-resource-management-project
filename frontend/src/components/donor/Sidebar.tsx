                ...
                <div className="flex items-center justify-between h-16 px-5 border-b border-slate-200 dark:border-white/5 shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-slate-400 dark:text-slate-500 uppercase tracking-widest">Donor Dashboard</p>
                        </div>
                    </div>
                        ...
                        return (
                            <Link key={item.href} href={item.href} onClick={() => setCollapsed(false)}
                                className={cn(
                                    ...
                                    active
                                        ? 'bg-gradient-to-r from-emerald-500/10 to-teal-500/10 dark:from-emerald-500/15 dark:to-teal-500/10 text-emerald-700 dark:text-white border border-emerald-200 dark:border-emerald-500/20 shadow-sm'
                                        : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-white/[0.04]'
                                )}>
                                <Icon className={cn('w-[18px] h-[18px] shrink-0', active ? 'text-emerald-500 dark:text-emerald-400' : '')} />

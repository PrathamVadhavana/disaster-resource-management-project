    ...
    return (
        <div className="space-y-6 max-w-2xl">
            <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Manage your NGO profile and contact information</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button type="submit" disabled={updateMut.isPending}
                    className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-sm font-semibold hover:from-blue-600 hover:to-cyan-600 disabled:opacity-50 transition-all">
